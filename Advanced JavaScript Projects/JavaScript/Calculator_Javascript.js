...
const Calculator = {
    ...
    Display_Value: '0',
    //This will hold the first operand for any expressions, we set it to null now.
    First_Operand: null,
    //This checks whether or not the second operand has been inputted by the user.
    Wait_Second_Operand: false,
    //The will hold the operator, we set it to null for now.
    operator: null,
};
...
function Handle_Operator(Next_Operator) {
    ...
    //When an operator key is pressed we convert the currect number displayed
    //on the screen to a number and then store the result in
...
const Perform_Calculation = {
    ...
    '+': (First_Operand, Second_Operand) => First_Operand + Second_Operand,
    '-': (First_Operand, Second_Operand) => First_Operand - Second_Operand,
    '=': (First_Operand, Second_Operand) => Second_Operand  //I don't understand this one.  I guess Second_Operand must store the answer for it to only return the  Second Operand.
};
...
Update_Display();
//This section monitors button clicks.  //So it's full of listeners.  Gotcha.
